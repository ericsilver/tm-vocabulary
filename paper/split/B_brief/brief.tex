...
pattern is that the funding premium exceeds it in every case. For
emergent consumer products the record shows funding without listings:
kombucha debuts were funded 3.4 times as often as same-year debuts, and
kombucha, plant-based milk, cold brew and CBD debuts produced no
listings at all --- in sectors whose successes typically exit by
acquisition, which this outcome cannot see.
