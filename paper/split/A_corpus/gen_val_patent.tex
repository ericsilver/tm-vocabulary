...
independently. The panel is trademark owners name-matched to PatentsView
patent assignees \citep{PatentsView}: 134{,}075 matched firm-years,
of which 94{,}181 across 17{,}506 firms contribute within-firm variation
under theme scoring (93{,}551 and 17{,}415 under term scoring). Each
axis is regressed on $\log(1 + \mathrm{patents})$ with firms absorbed
and errors clustered on the firm. The outcome is standardized, so
$\beta$ is the shift in standard deviations of the axis per unit of
log-patents; one unit is roughly a tripling of the patent count, and a
firm going from none to twenty patents moves about three units.
...
another (cell detail in the supplementary material). Nothing in the
split supports the complementarity story, with two caveats: a coarse
sorting can miss a finer-grained one, and conditioning on a successful
assignee match pushes any interaction toward zero.
