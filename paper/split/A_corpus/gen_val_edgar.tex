...
is different: at equal atypicality, being far from the class in either
direction helps ($+0.067$pp per standard deviation of $|L|$, $t = 7.7$),
but being on the leading side costs ($-0.047$pp per standard deviation
of $L$, $t = -7.8$). The U in the raw bins is exactly this pair: lagging filings
...
Nor is the U atypicality working through lead's construction (the
mechanical coupling stated in Section~\ref{sec:three_scorings}). On this
sample lead magnitude and atypicality correlate at $+0.25$, signed lead
at only $-0.10$, and cutting lead fifths within fifths of atypicality
keeps the structure: the most lagging fifth out-reports the most leading
in four of the five atypicality strata (by $0.08$ to $0.39$pp on sub-1\%
bases), the ordering reversing only in the most atypical fifth, where
the most leading debuts report most. The lagging tail's premium is not a ceiling
