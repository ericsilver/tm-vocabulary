...
table, the gate columns are computed on the 3.10 million registrations
...
representation. Appendix~\ref{app:representation} shows this as a length
...
cluster within owner: the within-owner correlation is 0.38 for gate
...
unaffected, because the gate regressions cluster errors on normalized
...
quarter on the gate outcome and by half on listing. Displays of the
