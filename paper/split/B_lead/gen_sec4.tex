...
registrations filed 2000--2004 and settled at the five-year proof; each
carries its dominant $T=50$ theme and the internet text flag of
Section~\ref{sec:internet}. Every theme$\times$flag cell holding at
least 5{,}000 registrations is shown. \emph{Share} is the cell's share
of the era's filings; \emph{of top fifth}, its share of the era's
pooled leading fifth. Q5$-$Q1 is the failure contrast between the most
leading and most lagging fifths, quintiles reassigned within the cell;
in the bottom block, quintiles are pooled across the era (first two
rows) or cut within class$\times$cohort (last two).}
\label{tab:reversaldecomp}
\input{results/reversal_decomp.tex}
\end{table}
