...
contrast observed since --- to the collapse, and back to $+1.5$ to
$+4.7$pp for every settled cohort from 2008. Neither prosecution-speed
selection in the earliest cohorts nor the cohort indexing drives it:
holding pendency in a common band leaves the series unchanged, and
indexed by filing year the contrast is $+7.9$ to $+9.6$pp for 1995--1999
filings against $-0.95$ for filings made in 2000.
...
\noindent Outside technology the penalty is positive in every era,
largest for late-1990s filings ($+4.5$pp) and smallest for 2000--2004
filings ($+1.2$), including the years in which the pooled series reads as
zero. Inside technology it swings by fifteen points: strongly positive
for filings made into the late 1990s, negative for those made in the
five years after, and positive again from 2008. The pooled quiet of
2002--2005 is a technology reversal partly offsetting a non-technology
positive, not an absence. (This table cuts quintiles within era and
group on the registration-cohort series of Figure~\ref{fig:eras};
Table~\ref{tab:techswing}'s raw row, computed on the settled
registrations used for the class and theme breakdowns, gives $+14.5$,
$-1.8$ and $+9.2$ for the same technology eras.)
...
every other, and by registration cohort it stays positive through 2015,
turning negative only in the last two settled cohorts
...
\emph{inside} a theme is steadier: $+2.6$ to $+4.8$pp in every era except
2000--2004, when it was $-1.3$, the same order as the penalty outside
technology.
...
moved to electronic media while the computer and information-services
wording fell out of the leading fifth, and inside several themes the
lagging fifth now failed more than the leading one. From 2008 the leading
fifth over-represents downloadable and online software four to one ---
the application store's vocabulary, the highest-failure theme (67.2\%),
with a within-theme contrast of $+3.3$pp in 2008--2014. The full theme
tour is in Supplementary Material \S S2.
...
So the swing has two layers. In most eras, a leading filing is a few
points more likely to fail than a lagging one in the same theme, class
and cohort, in technology as elsewhere. On top of that, each era's
leading vocabulary was concentrated in one or two themes whose marks
failed at their own rate: computer and information services in the
1990s, application software after 2008. In the trough between, the
language that had been leading fell out of the leading fifth, and the
marks still written in it failed at high rates
(Section~\ref{sec:reversal_decomp}).
...
Figure~\ref{fig:webscatter} places every class on two comparisons at once --- how
much more often its internet-bearing filings register, and how much more
often they fail the five-year proof; Supplementary Material \S S2
...
filings fail more often, by up to eleven points, most in legal and
personal services (60.1\% against 48.7\%). At the registration step the
goods classes sit to the right of zero: pooled across them,
internet-bearing applications reach registration 59.5\% of the time
against 56.0\% for the rest. For the industrial-goods classes the two
steps therefore move in opposite directions --- more likely to be
granted, then more likely to be cancelled for non-use six years later
--- the pattern Section~\ref{sec:gate_conclusion} describes, in which
registration responds to distance from the class's language and the
proof to whether the product stayed in commerce.
...
2012--2015 (Supplementary Material \S S2). Each class's clock appears to
start when the vocabulary arrives in it rather than when the internet
did, a shape consistent with falling entry costs followed by
normalization.
...
survived \emph{more} in the 2001--2005 cohorts ($+0.8$ to $+2.5$pp per
...
($-2$ to $-3$pp each). Outside technology, the non-internet series stays
between $0$ and $-1.4$pp throughout. What the internet changed, on
...
\subsection{What carried the reversal: a fading theme, and rewards in
goods and online retail}\label{sec:reversal_decomp}

The mid-sample reversal can be taken apart with the two instruments of
this section held at once: each 2000--2004 technology filing carries its
dominant theme and its internet flag, and the pooled lead quintiles of
Section~\ref{sec:eras} can be re-read cell by cell
(Figure~\ref{fig:reversal}).

The sign flip itself is carried by one theme, and not by reward. By
2000--2004 the computer, software, information and data services theme
--- the vocabulary that had supplied three quarters of the late-1990s
leading fifth (Table~\ref{tab:techthemes}) --- had largely left the
leading fifth: it still held 40\% of the era's filings but only 11\% of
its leading fifth, and its marks failed at 57\% and 61\%, among the
era's highest rates. Excluding that one theme flips the pooled contrast
from $-1.8$pp back to $+0.9$. At the pool level, then, much of the
reversal is the record of marks still written in a fading vocabulary
failing away from the leading end. And inside the theme, being leading
was never rewarded: $+2.6$pp among its other filings, $+1.8$ among its
internet-bearing ones, in this era as in every other.

The within-cell reward is real, and it sits in goods and retail themes.
Within class and cohort, internet-bearing filings show $-4.5$pp against
$-2.9$ for the rest. Cell by cell, the strongest single reward is in the
internet-bearing half of the retail store services theme --- online
retail, $-8.3$pp. The other large rewards are in filings that do not
name the internet: the apparatus and devices theme ($-7.1$), electronic
media ($-3.2$), and the non-internet half of retail store services
($-4.2$). Where filings described research and scientific services, the
penalty never left: that theme penalized its leading fifth by $+11.8$pp
in the same years.

What the cells show is where the reward lived; they do not show why. A
reading consistent with them is that in the years after the crash,
leading language paid where it described goods and the channels that
sold them --- devices, media, and online retail most of all --- while
the self-described information services that had led the boom were the
crowded language of a wave that had broken. The design cannot separate
that reading from its selection twin, that the firms still filing in
2001--2003 were already unusual survivors of the shakeout; and the
boom-and-bust ambiguity of Section~\ref{sec:eras} applies unchanged,
since these filings reached their proofs in 2006--2013.

\begin{figure}[!htbp]\centering
\includegraphics[width=0.9\textwidth]{results/fig_reversal.png}
\caption{The 2000--2004 reversal, cell by cell. Technology-class
registrations filed 2000--2004 and settled at the five-year proof, split by
their dominant $T=50$ theme and by whether their description names the
internet; every theme$\times$internet cell with at least 5{,}000
registrations is shown. Each point is the failure contrast between the
most leading and the most lagging fifth, quintiles cut within the cell,
with a 95\% binomial interval. Points left of zero are cells where
leading filings survived more often. Sizes, shares of the era's leading
fifth and failure rates are in Supplementary Material \S S2.}
\label{fig:reversal}
\end{figure}
...
episode table, and the wave-level facts are in Supplementary Material
\S S2.

\subsection{What the waves show}\label{sec:waves_conclusion}

The leading penalty is positive in every era outside technology and
episodic inside it, and much of the episode is between themes: each
era's leading vocabulary was concentrated in one or two themes that
failed at their own rate, while the within-theme penalty holds at $+2.6$
to $+4.8$pp in every era except 2000--2004. Web-based filings fail hardest in each class's own first
