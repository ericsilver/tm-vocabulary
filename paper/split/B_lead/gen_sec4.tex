...
\subsection{What carried the reversal: a dying theme, and an e-commerce
reward}\label{sec:reversal_decomp}
...
leading fifth (Table~\ref{tab:techthemes}) --- had crossed to the
lagging side of the pooled distribution: it still held 40\% of the era's
filings but only 11\% of its leading fifth, and its marks failed at 57\%
and 61\%, the era's worst rates. Excluding that one theme flips the
pooled contrast from $-1.8$pp back to $+0.9$. At the pool level, the
reversal is largely the record of marks still written in a dying
vocabulary failing on the lagging side. And inside the theme, being
leading was never rewarded: $+2.6$pp among its other filings, $+1.8$
among its internet-bearing ones, in this era as in every other.

The within-cell reward is real, and it is concentrated where internet
language met goods and commerce. Within class and cohort,
internet-bearing filings show $-4.5$pp against $-2.9$ for the rest.
Cell by cell, the strongest rewards sit in the internet-bearing half of
the retail store services theme --- the e-commerce cell, $-8.3$pp ---
in the apparatus and devices theme ($-7.1$), and in electronic media
($-3.2$). Where filings described services in the era's own service
words, the penalty never left: the research and scientific theme
penalized its leading fifth by $+11.8$pp in the same years.

What the cells show is where the reward lived; they do not show why. A
reading consistent with them is that post-crash online retail was open
space --- physical goods moving through a new channel, with the
surviving sellers' language converging on where the class was headed ---
while self-described online services were the crowded language of the
wave that had broken. The design cannot separate that reading from its
selection twin, that the firms still filing web marks in 2001--2003 were
already unusual survivors of the shakeout; and the boom-and-bust
ambiguity of Section~\ref{sec:eras} applies unchanged, since these
filings reached their proofs in 2006--2013.
