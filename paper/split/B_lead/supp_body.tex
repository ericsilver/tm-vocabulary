...
\subsection{The 2000--2004 reversal, cell by cell}

The cells behind Figure~\ref{fig:reversal}.
...
The rates behind Figure~\ref{fig:ladder} are in Table~\ref{tab:ladderS}.
...
\toprule
Rung & Measure & Q1 & Q2 & Q3 & Q4 & Q5 & Q5$-$Q1 (pp; $t$) \\
\midrule
...
The coefficients behind Figure~\ref{fig:staged} are in Table~\ref{tab:staged}.
...
In standard deviations of each measure across all debuts, with standard
