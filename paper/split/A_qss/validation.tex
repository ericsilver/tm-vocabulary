...
The sign reversal also holds on the current per-filing builds: among
the 1.46 million registered debut owners of Table~\ref{tab:edgar}'s
sample, word-scored lead predicts reaching SEC reporting at $+0.035$pp
per standard deviation ($t = 4.7$) and theme-scored lead at $-0.030$pp
($t = -4.1$), within class and filing year.

A natural guess is that the specificity is simply professional
drafting. It is not, mostly: within class and filing year, counsel of
record correlates with the specificity measures only weakly ($r = 0.08$
with log distinct terms, $0.06$ with the share of words the theme model
does not see, $-0.02$ with word-scored lead), and holding counsel leaves
the word-scored lead coefficient unchanged. Counsel is, however, a far
stronger predictor of the firm outcome than any text measure.
Represented debut owners reach SEC reporting at 0.69\%, self-filers at
0.15\%; within class and filing year, counsel alone explains about fifty
times as much of the variation as word-scored lead, and about four and a
half times as much as the specificity measures together.

The hazard, stated for reuse: term-resolved text-novelty measures can
manufacture firm-performance correlations out of lexical specificity, a
distribution-based rescoring --- one model fit --- is a cheap, decisive
diagnostic, and who drafted the filing is a stronger signal of firm
quality than anything in its words.
