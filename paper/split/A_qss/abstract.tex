...
whether the goods behind a registered mark were still being sold. On
...
weightings, five window constructions, a second model seed, and
...
to a control. Two hazards are documented: scoring words rather than
themes measures description length ($r = -0.68$), and firm-level
correlations built on word scoring dissolve under theme scoring. Corpus, scores and code are
public.
