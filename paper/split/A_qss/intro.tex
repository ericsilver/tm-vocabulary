...
The second asset is a measure. A topic model, fitted once on a sample
drawn equally from every industry and then applied to every filing,
reduces each description to a mix of themes --- whether the
...
Kullback--Leibler divergence, with what its own Nice class --- the international classification's 45
classes of goods and services --- filed in the five years before its
date and in the five years after. Their average is
...
two reference weightings, five window constructions, a refit of the
theme model under a second random seed (in the software class),
...
points under global themes to $0.7$ under per-class themes, and its
association with reaching SEC reporting vanishes once description
length is held.
...
correlates with log distinct terms at $-0.64$ within class. And firm-level
